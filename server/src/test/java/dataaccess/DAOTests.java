...
public class DAOTests {
    ...
    public void unsuccessfulRegistration() {
        ...
        new StandardAPITests().assertHttpError(result, HttpURLConnection.HTTP_FORBIDDEN, "Expected 403 Forbidden");
    }
    ...
    public void successfulLogin() {
        ...
        new StandardAPITests().assertHttpOk(result);
        Assertions.assertNotNull(result.getAuthToken(), "Expected token on successful login");
    ...
    public void successfulGameList() {
        ...
        new StandardAPITests().assertHttpOk(result);
        Assertions.assertTrue(result.getGames().length > 0, "Expected games after creation");
    }
    ...
    public void clearEmptyDatabase() {
        ...
        TestAuthResult newAuth = serverFacade.register(newUser);
        new StandardAPITests().assertHttpOk(newAuth);

        TestListResult listResult = serverFacade.listGames(newAuth.getAuthToken());
        new StandardAPITests().assertHttpOk(listResult);
        Assertions.assertEquals(0, listResult.getGames().length, "Expected no games in new DB");
    }
